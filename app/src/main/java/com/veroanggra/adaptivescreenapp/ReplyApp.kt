...
import com.veroanggra.adaptivescreenapp.ui.utils.ReplyContentType
import com.veroanggra.adaptivescreenapp.ui.utils.ReplyNavigationType
...
fun ReplyNavigationRail(
    ...
    NavigationRail(modifier = Modifier.fillMaxHeight()) {
        ...
        NavigationRailItem(
            selected = false,
            onClick = {/*TODO*/ },
            icon =  { Icon(imageVector = Icons.Default.Newspaper, stringResource(id = R.string.tab_article)) }
        )
        NavigationRailItem(
            selected = false,
            onClick = { /*TODO*/ },
            icon =  { Icon(imageVector = Icons.Outlined.ChatBubbleOutline, stringResource(id = R.string.tab_dm)) }
        )
        NavigationRailItem(
            selected = false,
            onClick = { /*TODO*/ },
    ...
    NavigationBar(modifier = Modifier.fillMaxWidth()) {
       NavigationBarItem(
        ...
        NavigationBarItem(
            selected = false,
            onClick = { /*TODO*/ },
            icon = { Icon(imageVector = Icons.Default.Newspaper, contentDescription = stringResource(id = R.string.tab_inbox)) }
        )
        NavigationBarItem(
            selected = false,
            onClick = { /*TODO*/ },
            icon = { Icon(imageVector = Icons.Outlined.ChatBubbleOutline, contentDescription = stringResource(id = R.string.tab_inbox)) }
        )
        NavigationBarItem(
            selected = false,
            onClick = { /*TODO*/ },
...
fun NavigationDrawerContent(
    ...
    Column(
        ...
        NavigationDrawerItem(
            ...
            icon = { Icon(imageVector =  Icons.Default.ChatBubbleOutline, contentDescription =  stringResource(id = R.string.tab_dm)) },
            colors = NavigationDrawerItemDefaults.colors(unselectedContainerColor = Color.Transparent),
            onClick = { /*TODO*/ }
        )
        NavigationDrawerItem(
            ...
            icon = { Icon(imageVector =  Icons.Default.Newspaper, contentDescription =  stringResource(id = R.string.tab_groups)) },
            colors = NavigationDrawerItemDefaults.colors(unselectedContainerColor = Color.Transparent),
            onClick = { /*TODO*/ }
        )
    }
